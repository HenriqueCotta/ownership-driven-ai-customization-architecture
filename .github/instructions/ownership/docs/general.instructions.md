...
- Do not introduce Tycherion-specific assumptions into the canonical architecture docs.

## Follow-Through Triggers

- If docs structure, page naming, or example layout changes, update both language trees, root READMEs, and `scripts/check_repo.py`.
