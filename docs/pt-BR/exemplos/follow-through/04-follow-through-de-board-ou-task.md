...
Task tracking normalmente é um overlay transversal.
...
- se escopo, status, critérios de aceitação ou follow-up work mudaram materialmente, revise task tracking
