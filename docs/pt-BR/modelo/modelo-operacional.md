...
Casos diferentes de follow-through geralmente devem reutilizar as mesmas poucas skills, como review de mudança, sync de docs ou debugging, em vez de criar uma skill por trigger.
